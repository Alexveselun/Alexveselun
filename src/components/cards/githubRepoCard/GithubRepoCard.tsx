...
import ProjectLanguages from "../../media/projectLanguages/ProjectLanguages";
import "./GithubRepoCard.css";

interface Repo {
  id: string; // Ensure this matches your actual Repo structure
  name: string;
  description: string;
  url: string;
  stargazers: {
  ...
  forkCount: number;
  createdAt: string;
  languages: any; // Replace with a more specific type if possible
}
      ...
      <div className="repo-card-div" onClick={() => openRepoInNewTab(repo.url)}>
        ...
        <div className="repo-left-stat">
          <span>
            ...
            <p className="heading-detail-text">{repo.stargazers.totalCount}</p>
          </span>
          <span>
            <svg
              aria-hidden="true"
              className="octicon repo-fork-svg"
              height="20"
              role="img"
              viewBox="0 0 10 16"
              width="12"
            ...
            <p className="heading-detail-text">{repo.forkCount}</p>
          </span>
        </div>
